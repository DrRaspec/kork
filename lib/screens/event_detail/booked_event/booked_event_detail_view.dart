              ...
              child: SingleChildScrollView(
                child: Stack(
                  children: [
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        controller.formatTime(
                                          controller.eventData.event.startTime,
                                        ),
                                        style: TextStyle(
                                          fontSize: 12,
                                          color:
                              ...
                              SizedBox(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) => ticketType(
                                    controller
                                        .eventData.event.tickets[index].ticketType,
                                  ),
                                  separatorBuilder: (context, index) =>
                                  const SizedBox(width: 15),
                                  itemCount:
                                  controller.eventData.event.tickets.length,
                                ),
                              ),
                    ...
                    controller.eventData.event.attendees.isEmpty
